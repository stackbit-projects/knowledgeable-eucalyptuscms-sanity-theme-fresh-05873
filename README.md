...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/602058731cef9100162811e0
...
To start editing your site, you can use the Sanity interface at https://knowledgeable-eucalyptuscms-sanity-theme-fresh-05873.sanity.studio/.
...
Generated at `2021-02-07T21:15:41.019Z` by Stackbit version `0.3.48`.